...
export class CartService {
  ...
  computerCartTotals() {
    ...
    // publish the new values... all subscribers willl recivre new data
  ...
  logCartData(totalPriceValue: number, totalQuantityValue: number) {
    ...
    for (let tempCartItem of this.cartItems){
      ...
      console.log(`name: ${tempCartItem.name}, qauntity=${tempCartItem.quantity}, unit price=${tempCartItem.unitPrice}, subTotalPrice=${subTotalPrice}`)
    }
